    ...
    <>
      <footer className="footer sm:footer-horizontal bg-base-100 text-base-content p-10">
        <nav>
          ...
          <p className="w-80">
            This project emphasizes clean UI using Tailwind CSS, secured routes
            with Firebase Authentication, and a modern, professional app
            structure using private routes, protected data, and user
            authorization.
          </p>
        </nav>
        <nav>
